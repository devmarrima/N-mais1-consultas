package com.devmarrima.N_mais1_consultas;
...
import com.devmarrima.N_mais1_consultas.repositories.CategoryRepository;
import com.devmarrima.N_mais1_consultas.repositories.ProductRepository;

@SpringBootApplication
public class NMais1ConsultasApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(NMais1ConsultasApplication.class, args);
	}
